    ...
    <section id="services">
        <div class="container">
            <div class="row" style="margin-top:5em ;">
                <div class="col-md-4" style="background-color:#E2415F; color:#fff ; font-weight:100; padding:50px 30px">
                    <p style="display:block;font-size:2em">Be seen, get connected.</p>
                    <br/>
                    <p>We don’t just build websites, we build your business, because we've got Passion, dedication, and a lot of coffee.</p>
                </div>
                ...
                <div class="col-md-7">
                        ...
                        @endif
                    <h2 class="section-heading" style="position:absolute; bottom:0; background: -webkit-linear-gradient(#1771A3, #26323E);-webkit-background-clip: text;-webkit-text-fill-color: transparent;">Web Development</h2>
                </div>
            </div>
