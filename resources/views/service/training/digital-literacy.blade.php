        ...
        <div class="container">
            <div class="row" style="margin-top:5em">
                    <div class="col-md-4" style="background-color:#00B2E8; color:#fff ; box-sizing:border-box; font-weight:100; padding:50px 30px">
                        <p style="display:block;font-size:2em">Microsoft Digital Literacy</p>
                        <br/>
                    ...
                    <div class="col-md-7">
                            ...
                            @endif
                        <h2 class="section-heading" style="position:absolute; bottom:0; background: -webkit-linear-gradient(#1771A3, #26323E);-webkit-background-clip: text;-webkit-text-fill-color: transparent;">Digital Literacy</h2>
                    </div>
            </div>
